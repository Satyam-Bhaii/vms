...
display_header() {
    ...
    echo "║           ╚═╝     ╚═╝╚═╝  ╚═╝╚══════╝╚══════╝            ║"
    echo "║                                                            ║"
    echo "║              ${WHITE}PIXLE CORE - VM MANAGER${CYAN}                    ║"
...
create_vm() {
    ...
    case $os_choice in
        ...
        7) OS_TYPE="Rocky"; CODENAME="9"; IMG_URL="https://download.rockylinux.org/pub/rocky/9/images/x86_64/Rocky-9-GenericCloud-Base.latest.x86_64.qcow2" ;;
        8) OS_TYPE="CentOS"; CODENAME="stream9"; IMG_URL="https://cloud.centos.org/centos/9-stream/x86_64/images/CentOS-Stream-GenericCloud-9-latest.x86_64.qcow2" ;;
